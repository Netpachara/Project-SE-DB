        ...
        <div class="row" style = "top: 15%; position: absolute;">
            ...
            <div class="col-md-auto" style =  "text-align: left;">
                <ul class="nav nav-tabs" style="font-size:22px; font-weight:bold;">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="http://127.0.0.1/RegWeb/DeptTeachStudent.php">ตารางสอนภาควิชา</a>
                    </li>
                    <li class="nav-item">
                ...
                <table class = "mix" style = "margin-top: 30; text-align: center; margin-bottom: 100;">
                    ...
                    <?php $room_info = "SELECT * FROM room INNER JOIN student ON room.dr_ID = student.d_ID WHERE student.email = '$username'";
                ...
                <h5 style = "margin-top: 30;">ตารางสอนภาควิชา อังคาร-ศุกร์</h5>
                <table class = "mix" style = "margin-top: 30; text-align: center; margin-bottom: 100;">
                    <tr>
                        <td>วันเวลา<br>/ห้อง</td>
                        <td>8:00</td>
