        ...
        <div class="row" style = "top: 15%; position: absolute;">
            ...
            <div class="col-md-auto" style =  "text-align: left;">
                <ul class="nav nav-tabs" style="font-size:22px; font-weight:bold;">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="http://127.0.0.1/RegWeb/DeptTeachAdmin.php">ตารางเรียนภาควิชา</a>
                    </li>
                    <li class="nav-item">
                ...
                <h5 style = "margin-top: 30;">ตารางสอนภาควิชา จันทร์-พฤหัสบดี</h5>
                <table class = "mix" style = "margin-top: 30; text-align: center; margin-bottom: 70;">
                    <tr>
                    ...
                    <?php $room_info = "SELECT * FROM room INNER JOIN admin ON room.dr_ID = admin.dept_ID";
                ...
                <h5>ตารางสอนภาควิชา อังคาร-ศุกร์</h5>
